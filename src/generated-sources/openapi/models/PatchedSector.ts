 ...
 * @export
 * @interface PatchedSector
 */
export interface PatchedSector {
    /**
     * 
     * @type {string}
     * @memberof PatchedSector
     */
    readonly id?: string;
    /**
...
/**
 * Check if a given object implements the PatchedSector interface.
 */
export function instanceOfPatchedSector(value: object): value is PatchedSector {
    return true;
}

export function PatchedSectorFromJSON(json: any): PatchedSector {
    return PatchedSectorFromJSONTyped(json, false);
}

export function PatchedSectorFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchedSector {
    if (json == null) {
        return json;
    }
    return {
        ...
        'azimuth': json['azimuth'] == null ? undefined : json['azimuth'],
        'width': json['width'] == null ? undefined : json['width'],
        'node': json['node'] == null ? undefined : AccessPointNodeFromJSON(json['node']),
    };
}

export function PatchedSectorToJSON(value?: Omit<PatchedSector, 'id'|'latitude'|'longitude'|'altitude'|'links_from'|'links_to'> | null): any {
    if (value == null) {
        return value;
    }
    return {
