...
Forms for [meshdb](https://github.com/nycmeshnet/meshdb). Live version hosted at https://forms.mesh.nycmesh.net/
...
- Query form, a legacy interface used by mesh volunteers to query information from meshDB
   (use of https://db.mesh.nycmesh.net/admin/) is recommended instead for new workflows
...
- To setup against beta/prod, continue to the next section and use `https://db.mesh.nycmesh.net` as the value for `NEXT_PUBLIC_MESHDB_URL`
